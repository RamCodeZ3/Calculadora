...
numeros = ["**","7", "8", "9","/", "4", "5", "6","*", "1", "2", "3","-","0","00",".","+"]
fila = 1
columna = 3

for numero in numeros:
    boton_numerico = tk.Button(app, text=numero, height=3, width=8,border=0,font=("Sans", 12),bg="#31404F",fg="white", command=lambda num=numero: clic(num) )
...
Result = tk.Button(text="=",width=20,border=0,fg="white",font=("Sans", 16), command= calcular, bg="#3EEC30")
Result.grid()
Result.place(x=82, y=375)

Delete= tk.Button(text="CE",width=6, height=1, bg="#EB0101", fg="white",border=0,font=("Sans", 16), command= clear)
Delete.grid()
Delete.place(x=2,y=375)

Delete2 = tk.Button(app, text="X", height=3, width=8,border=0,font=("Sans", 12),bg="#31404F",fg="white", command=clear2)
Delete2.grid(row=1, column=0)

Sqrt = tk.Button(app, text="√2", height=3, width=8,border=0,font=("Sans", 12),bg="#31404F",fg="white", command=Raiz )
Sqrt.grid(row=1, column=1)

insert_signN = tk.Button(app, text="-", height=3, width=8,border=0,font=("Sans", 12),bg="#31404F",fg="white", command=insert_sign)
